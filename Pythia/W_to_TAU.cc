...
namespace Pythia8 {
  ...
  struct W_to_TAU : public UserHooks {
    ...
    bool doVetoResonanceDecays(Event& process) {
      ...
      int nT = 0, nH = 0, nE_MU_TAU = 0, nTAU = 0;
      bool topFlag = false;
	...
	if ( wd1.idAbs() == 15 || wd2.idAbs() == 15 ) { 
	  nTAU += 1;}// cout << "nTAU+=1" << endl ;}
...
*/
  ...
  Sacrifice::UserHooksFactory::Creator<Pythia8::W_to_TAU> TTOTAU("W_to_TAU");
