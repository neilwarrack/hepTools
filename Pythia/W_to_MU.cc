...
namespace Pythia8 {
  ...
  struct W_to_MU : public UserHooks {
    ...
    bool doVetoResonanceDecays(Event& process) {
      ...
      int nT = 0, nH = 0, nE_MU_TAU = 0, nMU = 0;
      bool topFlag = false;
	...
	if ( wd1.idAbs() == 13 || wd2.idAbs() == 13 ) { 
	  nMU += 1;}// cout << "nMU+=1" << endl ;}
...
*/
  ...
  Sacrifice::UserHooksFactory::Creator<Pythia8::W_to_MU> TTOE("W_to_MU");
